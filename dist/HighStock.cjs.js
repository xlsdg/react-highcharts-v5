...
var _isString = _interopDefault(require('lodash-es/isString'));
...
var ElementResizeDetector = _interopDefault(require('element-resize-detector'));
var HighCharts = _interopDefault(require('highcharts/highstock'));
...
var IHighCharts = wrapHighCharts('stock', HighCharts);
IHighCharts.__highcharts__ = HighCharts;

module.exports = IHighCharts;
